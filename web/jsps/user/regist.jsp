        ...
        <form action="<c:url value='/UserServlet'/>" method="post" id="registForm">
            ...
            <table id="tableForm">
                <tr>
                    ...
                    <td><input class="inputClass" type="text" name="loginname" id="loginname"
                               value="${form.loginname}"/>
                    </td>
                    <td class="tdError">
                        <label class="errorClass" id="loginnameError"
                        >${errors.loginname}</label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    /></td>
                    <td>
                        <label class="errorClass" id="relloginpassError">${errors.relloginpass}</label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="tdText"></td>
                    <td>
                        <input type="image" src="<c:url value='/images/regist1.jpg'/>"/>
                        <%--<img src="/images/regist1.jpg">--%>
                    </td>
                    <td>
                        <label></label>
                    </td>
